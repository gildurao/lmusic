...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=LMusic Demo Installer\n"
      else:
        line="OutputBaseFilename=LMusic Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the LMusic Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the LMusic installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=LMusic Demo installer\n"
     else:
       line="SetupWindowTitle=LMusic installer\n"
